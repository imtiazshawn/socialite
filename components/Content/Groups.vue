    ...
    <div class="main_content">
            <div class="mcontainer">
                ...
                <div class="flex justify-between relative md:mb-4 mb-3">
                    ...
                    <nuxt-link to="/groups/create-group" class="flex items-center justify-center h-9 lg:px-5 px-2 rounded-md bg-blue-600 text-white space-x-1.5 absolute right-0">
                        ...
                        <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-grid-small uk-grid">
                            ...
                            <li>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="timeline-group.html" class="font-semibold text-lg truncate">Wedding Ideas</a>
                                        <div class="flex items-center flex-wrap space-x-1 mt-1 text-sm text-gray-500 capitalize">
                                            <a href="#"> <span> 232k members </span> </a>
                                            <a href="#"> <span> 1.7k post a day </span> </a>
                                        </div>  
