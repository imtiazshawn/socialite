    ...
    <div class="main_content">
        ...
        <div class="p-12 pb-0 bg-white shadow">
            <div class="container pb-0">
                ...
                <h1 class="md:text-3xl text-lg font-semibold text-gray-900 leading-0 mb-3"> Components </h1>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base mb-10"> Create a list of items that can be shown individually by clicking an
                                item's header. </p>
                            ...
                            <p class="text-base mb-10"> To display multiple content sections at the same time without one
                                collapsing when the other one is opened, add the <code>multiple: true</code> option to the
                                <code>uk-accordion</code> attribute.
                            </p>
                        ...
                        <div class="w-1/4 md:block hidden">
                            <ul class="docs-list" uk-scrollspy-nav="closest: li; scroll: true"
                                uk-sticky="offset:90;media : @m">
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base mb-10"> There are several style modifiers available. Just add one of the
                                following classes to apply a different look. </p>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-blue-500 border p-4 relative rounded-md" uk-alert>
                                    ...
                                    <p class="text-white text-opacity-75">Lorem ipsum dolor sit amet, consectetur adipiscing
                            ...
                            <div class="bg-whit border-t-4 border-red-600 p-5 shadow-lg relative rounded-md" uk-alert>
                                ...
                                <div class="flex space-x-2 items-center justify-end mt-2">
                                    <button type="button" class="uk-alert-close py-2 px-4 rounded-md font-semibold">
                                        Cancle</button>
                                    <button type="button"
                                        class="bg-red-100 text-red-600 py-2 px-4 rounded-md font-semibold "> Deactivate
                                    </button>
                                </div>
                            </div>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <div uk-filter="target: .js-filter">
                                ...
                                <ul class="js-filter grid md:grid-cols-3 grid-cols-3 gap-5 text-lg capitalize">
                                    <li class="data-color-blue">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-28 bg-blue-500">
                                            Item</div>
                                    </li>
                                    <li class="data-color-green">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-28 bg-green-500">
                                            Item</div>
                                    </li>
                                    <li class="data-color-red">
                                        <div class="text-white rounded-md flex items-center justify-center h-28 bg-red-500">
                                            Item</div>
                                    </li>
                                    <li class="data-color-red">
                                        <div class="text-white rounded-md flex items-center justify-center h-28 bg-red-500">
                            ...
                            <p class="text-base mb-10"> Items can have different meta data for filtering. You just need to
                                define the HTML classes or <code>data</code> attributes and create the corresponding CSS
                                selectors for the filter controls. This example uses <code>data</code> attributes for the
                            ...
                            <div uk-filter="target: .js-filter">
                                ...
                                <ul class="js-filter grid md:grid-cols-3 grid-cols-3 gap-5 text-lg capitalize">
                                    ...
                                    <li class="data-color-green tag-large">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-36 bg-green-500">
                                            Item large</div>
                                    </li>
                                </ul>
                            ...
                            <p class="text-base mb-10"> Define different types of meta data and add any number of controls
                                to filter them. The filter controls are exclusive, meaning just one criteria is filtered at
                                a time. </p>
                            ...
                            <div uk-filter="target: .js-filter">
                                ...
                                <ul class="js-filter grid md:grid-cols-3 grid-cols-3 gap-5 text-lg capitalize">
                                    ...
                                    <li class="data-color-blue data-size-large">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-36 bg-blue-500">
                                            Item</div>
                                    </li>
                                    ...
                                    <li class="data-color-red data-size-large">
                                        <div class="text-white rounded-md flex items-center justify-center h-36 bg-red-500">
                                            Item</div>
                                    </li>
                                    ...
                                    <li class="data-color-blue data-size-small">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-20 bg-blue-500">
                                            Item</div>
                                    </li>
                                    <li class="data-color-green data-size-small">
                                        <div
                                            class="text-white rounded-md flex items-center justify-center h-20 bg-green-500">
                                            Item</div>
                                    </li>
                                    <li class="data-color-red data-size-small">
                                        <div class="text-white rounded-md flex items-center justify-center h-20 bg-red-500">
                                            Item</div>
                                    </li>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <hr><br><br>
                            <h3 class="text-lg font-semibold mb-2" id="Style-modifiers"> Style modifiers</h3>
                            <p class="text-base mb-10"> You can place a grid from the <a href="grid">Grid component</a>
                                inside a drop. Just wrap the content with a <code>&lt;div&gt;</code> element and add the
                                <code>uk-grid</code> attribute. If the grid should stack automatically, whenever the drop no
                                longer fits its container, just add the <code>.uk-drop-grid</code> class
                            </p>
                            ...
                            <p class="text-base mb-10">Add one of the following options to the <code>uk-drop</code>
                                attribute to adjust the drop's alignment. </p>

                            <pre
                                class="p-2 rounded-md mb-6 border-l-4 border-red-400 pl-4 bg-white shadow"><code class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">uk-drop</span>=<span class="hljs-string">"pos: top-left"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                            ...
                            <div class="bg-white shadow p-3 space-x-1 space-y-1 rounded-md">
                                ...
                                <code
                                    class="bg-red-50 border-l-2 border-red-500 p-2 rounded leading-10">bottom-center</code>
                                <code
                                    class="bg-red-50 border-l-2 border-red-500 p-2 rounded leading-10">bottom-justify</code>
                            ...
                            <div class="gap-4 grid grid-flow-col  p-4 rounded-md bg-gray-100 border ">
                                ...
                                <div>
                                    ...
                                    <div uk-drop="pos: top-right">
                                        <div class="card p-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                            ...
                            <p class="text-base mb-10"> To define a custom offset between the drop container and the toggle,
                                add the <code>offset</code> option with a value for the offset, measured in pixels. </p>

                            <pre
                                class="p-2 rounded-md mb-6 border-l-4 border-red-400 pl-4 bg-white shadow"><code class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">uk-drop</span>=<span class="hljs-string">"offset: 80"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <hr><br><br>
                            <h3 class="text-lg font-semibold mb-2" id="Position"> Position </h3>
                            <p class="text-base mb-10">Add one of the following options to the <code>uk-dropdown</code>
                                attribute to adjust the drop's alignment. </p>

                            <pre
                                class="p-2 rounded-md mb-6 border-l-4 border-red-400 pl-4 bg-white shadow"><code class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">uk-dropdown</span>=<span class="hljs-string">"pos: top-left"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                            ...
                            <pre
                                class="p-2 rounded-md mb-6 border-l-4 border-red-400 pl-4 bg-white shadow"><code class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">uk-dropdown</span>=<span class="hljs-string">"offset: 80"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                            <br>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <hr>
                            <p class="text-sm mt-3 mb-10"> The lightbox component is fully responsive and supports touch and
                                swipe navigation, as well as mouse drag for desktops. When swiping between slides the
                                animation literally sticks at your fingertip or mouse cursor. Clicking fast on the previous
                                and next navigation, will make animations even accelerate to keep up with your pace. All
                                animations are hardware accelerated for a smoother performance.</p>


                            <div uk-lightbox>
                                <a class="button gray" href="assets/images/demos/docs-demo/photo.jpg">Open Lightbox</a>
                            </div>

                            <br><br>
                            <hr><br>
                            <h3 class="text-lg font-semibold mb-2" id="Caption">Caption </h3>
                            <p class="text-base mb-10"> To display a caption at the bottom of the lightbox, set the
                                <code>data-caption</code> attribute on an anchor
                            </p>

                            <div uk-lightbox>
                                <a class="button gray" href="assets/images/demos/docs-demo/light.jpg"
                                    data-caption="Caption">Open Lightbox</a>
                            </div>

                            <br><br>
                            <hr><br>
                            <h3 class="text-lg font-semibold mb-2" id="Animations"> Animations </h3>
                            <p class="text-base mb-10"> By default, the Lightbox gallery uses a slide animation. You can set
                                the <code>animation</code> option to use a different one. Possible values are
                                <code>slide</code>, <code>fade</code> and <code>scale</code>.
                            </p>
                            ...
                            <div class="uk-child-width-1-3@m" uk-grid uk-lightbox="animation: slide">
                                <div>
                                    <a class="uk-inline" href="assets/images/demos/docs-demo/photo.jpg"
                                        data-caption="Caption 1">
                                        <img src="assets/images/demos/docs-demo/photo.jpg" alt="">
                                    </a>
                                </div>
                                <div>
                                    <a class="uk-inline" href="assets/images/demos/docs-demo/dark.jpg"
                                        data-caption="Caption 2">
                                        <img src="assets/images/demos/docs-demo/dark.jpg" alt="">
                                    </a>
                                </div>
                                <div>
                                    <a class="uk-inline" href="assets/images/demos/docs-demo/light.jpg"
                                        data-caption="Caption 3">
                                        <img src="assets/images/demos/docs-demo/light.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <p class="text-base mb-10"> A lightbox is not restricted to images. Other media, like videos,
                                can be displayed as well. The video will pause whenever it's not visible and resume once it
                                becomes visible again. To display a poster image for a video, set the
                                <code>data-poster</code> attribute.
                            </p>

                            <div class="flex space-x-3" uk-lightbox>
                                <a class="button gray" href="assets/images/demos/docs-demo/light.jpg"
                                    data-caption="Image">Image</a>
                                <a class="button gray" href="https://yootheme.com/site/images/media/yootheme-pro.mp4"
                                    data-caption="Video">Video</a>
                                <a class="button gray" href="https://www.youtube.com/watch?v=c2pz2mlSfXA"
                            ...
                            <p class="text-base mb-10"> You can add custom attributes to lightbox content items by using the
                                <code>data-attrs</code> attribute. The attributes are passed like the usual component
                                options, e.g. <code>data-attrs="width: 1280; height: 720;"</code>
                            </p>


                            <div uk-lightbox>
                                <a class="button gray" href="https://www.youtube.com/watch?v=c2pz2mlSfXA"
                                    data-caption="YouTube" data-attrs="width: 1280; height: 720;">YouTube</a>
                            </div>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base mb-10">To create a close button, enable its functionality and add proper
                                styling and positioning, add the <code>.uk-modal-close-default</code> class to an
                                <code>&lt;a&gt;</code> or <code>&lt;button&gt;</code> element. To place the close button
                                outside the modal, add the <code>.uk-modal-close-outside</code> class.
                            </p>
                            ...
                            <div id="modal-close-default" uk-modal>
                                <div class="uk-modal-dialog uk-modal-body rounded-md shadow-2xl">
                                    <button class="uk-modal-close-default bg-gray-300 p-2 rounded-full m-3" type="button"
                                        uk-close></button>
                                    <h2 class="mb-2 uk-modal-title">Headline</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                            ...
                            <div id="modal-close-outside" uk-modal>
                                <div class="uk-modal-dialog uk-modal-body rounded-md shadow-2xl">
                                    <button class="uk-modal-close-outside bg-gray-300 p-2 rounded-full" type="button"
                                        uk-close></button>
                                    <h2 class="mb-2 uk-modal-title">Headline</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                            ...
                            <p class="text-base mb-10">To divide the modal into different content sections, use the
                                following classes..</p>
                            ...
                            <p class="text-base mb-10">By default, the page will scroll with the modal, if its content
                                exceeds the window height. To apply a scrollbar inside the modal, add the
                                <code>overflow-auto</code> to the modal body.
                            </p>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <button class="button gray" type="button"
                                onclick="UIkit.notification({message: 'Notification message'})">Click me</button>

                            <br><br><br>
                            <hr><br><br>
                            <h3 class="text-lg font-semibold mb-2" id="HTML"> HTML message</h3>
                            <p class="text-base mb-10"> You can use HTML inside your notification message, like an icon from
                                the Icon component. </p>

                            <pre
                                class="p-2 rounded-md mb-6 border-l-4 border-red-400 pl-4 bg-white shadow"><code class="lang-js hljs javascript">UIkit.notification(<span class="hljs-string">"&lt;span uk-icon='icon: check'&gt;&lt;/span&gt; Message"</span>);</code></pre>

                            <button class="button gray demo" type="button"
                                onclick="UIkit.notification({message: ' <div class=\'flex\'> <i class=\'icon-feather-check mr-2\'></i> <div class=\'text-red-600 mr-4\'>  Message </div> with an icon </div>'})">With
                                icon</button>
                            ...
                            <div class="grid lg:grid-cols-4 grid-cols-2 gap-3">
                                ...
                                <button class="button gray" type="button"
                                    ...
                                    Left</button>
                                <button class="button gray col-span-2" type="button"
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base mb-10"> Create an off-canvas sidebar that slides in and out of the page,
                                which is perfect for creating mobile navigations. </p>
                            ...
                            <p class="text-base mb-10"> To add an overlay, blanking out the page, add the
                                <code>overlay: true</code> parameter to the <code>uk-offcanvas</code> attribute.
                            </p>
                            ...
                            <p class="text-base mb-10"> Add the <code>flip: true</code> parameter to the
                                <code>uk-offcanvas</code> attribute to adjust its alignment, so that it slides in from the
                                right.
                            </p>
                            ...
                            <p class="text-base mb-10">By default, the off-canvas slides in. But you can actually choose
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-sm">This example uses the <code>repeat: true</code> option. Scroll up and down to
                                see the triggered animations. The layout is made with the <a href="card">Card component</a>.
                            </p>

                            <br><br> <br>
                            <hr> <br>
                            <h3 class="text-lg font-semibold mb-2" id="Groups"> Groups</h3>
                            <p class="text-base mb-10"> You can also group scrollspy elements, so you won't have to apply
                                the attribute to each of them. Just add the <code>uk-scrollspy="target: SELECTOR"</code>
                                attribute to a container element, targeting the selector of the items you want to animate
                                inside the container. When using a delay, it will be applied cumulatively to the items that
                                scroll into view. </p>
                            ...
                            <p class="text-base mb-10"> You can also give each target a separate <code>cls</code> option.
                                Just add the <code>uk-scrollspy-class="CLASS"</code> attribute to a target element. It will
                                override the <code>cls</code> option set on the component. </p>

                            <div class="uk-child-width-1-3@m" uk-grid
                                uk-scrollspy="cls: uk-animation-slide-bottom; target: .card; delay: 300; repeat: true">
                                <div>
                                    <div class="card p-5">
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base"> Create sortable grids and lists to rearrange the order of its elements.
                            </p>

                            <hr class="my-3">
                            <p class="text-sm mb-6">Drag and drop an element to a new location within the sortable grid,
                                while the other items adjust to fit. This is great, if you want to sort items like gallery
                                or menu items, for example.</p>

                            <ul class="grid lg:grid-cols-4 grid-cols-2 gap-3 bg-pink-100 p-4 rounded-md"
                                uk-sortable="handle: .drag-me">
                                <li>
                            ...
                            <p class="text-base mb-10"> By default, the entire sortable element can be used for drag and
                                drop sorting. To create a handle which will be used instead, just add the
                                <code>handle: SELECTOR</code> option to the attribute and add the handle class to the
                                element that you want to use as a handle
                            </p>

                            <ul class="grid lg:grid-cols-3 grid-cols-2 gap-3 bg-green-100 p-4 rounded-md"
                                uk-sortable="handle: .uk-sortable-handle">
                                <li>
                                    <div class="bg-green-500 rounded text-center text-white flex items-center">
                                        <span
                                            class="uk-sortable-handle rounded-l-md p-3 text-base bg-green-600 mr-5 text-white">
                                            <i class="icon-feather-move"></i> </span>
                                        Item 1
                                    </div>
                                </li>
                                <li>
                            ...
                            <p class="text-base mb-10"> To be able to sort items from one list to another, you can group
                                them by adding the <code>group: GROUP-NAME</code> option to the <code>uk-sortable</code>
                                attribute on each list. </p>

                            <div class="grid md:grid-cols-3 gap-2">

                                <div class="bg-blue-200 rounded-md p-4 pb-10">
                                    <h4
                                        class="-m-4 mb-4 border-b border-blue-300 font-semibold mb-2 px-3 py-2 text-lg text-blue-700">
                                        Group one</h4>
                                    <div uk-sortable="group: sortable-group">

                                        <div class="bg-blue-500 rounded text-center text-white flex items-center mb-2">
                                            <span
                                                class="uk-sortable-handle rounded-l-md p-3 text-base bg-blue-600 mr-5 text-white">
                                                <i class="icon-feather-move"></i> </span>
                                            Item
                                        </div>
                                        <div class="bg-blue-500 rounded text-center text-white flex items-center mb-2">
                                ...
                                <div class="bg-green-200 rounded-md p-4 pb-10">
                                    <h4
                                        class="-m-4 mb-4 border-b border-green-300 font-semibold mb-2 px-3 py-2 text-lg text-green-700">
                                        Group two</h4>
                                    <div uk-sortable="group: sortable-group">
                                ...
                                <div class="bg-pink-200 rounded-md p-4 pb-10">
                                    <h4
                                        class="-m-4 mb-4 border-b border-pink-300 font-semibold mb-2 px-3 py-2 text-lg text-pink-700">
                                        Group three</h4>
                                    <div uk-sortable="group: sortable-group">

                                        <div class="bg-pink-500 rounded text-center text-white flex items-center mb-2">
                                            <span
                                                class="uk-sortable-handle rounded-l-md p-3 text-base bg-pink-600 mr-5 text-white">
                                                <i class="icon-feather-move"></i> </span>
                                            Item
                                        </div>
                                        <div class="bg-pink-500 rounded text-center text-white flex items-center mb-2">
                            ...
                            <p class="text-base mb-10"> You can also apply one or more custom classes to items when they are
                                being dragged. To do so, add the <code>cls-custom: MY-CLASS</code> option to the attribute.
                            </p>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <p class="text-base mb-10"> Add one of the following options to the <code>uk-tooltip</code>
                                attribute to adjust the tooltip's alignment. </p>

                            <pre
                                class="bg-gray-200 p-3 mb-4 rounded-md"><code class="lang-html hljs xml"><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">uk-tooltip</span>=<span class="hljs-string">"title: Hello World; pos: top-left"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></code></pre>


                            <ul class="grid lg:grid-cols-4 grid-cols-2 gap-3 bg-purple-200 p-4 rounded-md">
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white" uk-tooltip="Hello World">
                                        Top</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: top-left">Top Left</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: top-right">Top Right</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: bottom">Bottom</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: bottom-left">Bottom Left </div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: bottom-right">Bottom Right</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: left">Left</div>
                                </li>
                                <li>
                                    <div class="bg-purple-500 rounded py-4 text-center text-white"
                                        uk-tooltip="title: Hello World; pos: right">Right</div>
                                </li>
                            </ul>
                            ...
                            <p class="text-base mb-10"> If you want the tooltip to appear with a little delay, just add the
                                <code>delay</code> option to the <code>uk-tooltip</code> attribute with your value in
                                milliseconds.
                            </p>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <hr class="my-3">
                            <p class="text-sm mb-10">The Slider component is fully responsive and supports touch and swipe
                                navigation as well as mouse drag for desktops. It even accelerates to keep up with your pace
                                when you click through previous and next navigation. All animations are hardware accelerated
                            ...
                            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
                                ...
                                <ul class="uk-slider-items uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-4@m">
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider1.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider2.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider3.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider4.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider1.jpg" alt="">
                                    </li>
                                ...
                                <a class="uk-position-center-left uk-position-small uk-hidden-hover text-white p-4" href="#"
                            ...
                            <p>To apply a gap to the slider items, use the <a href="https://getuikit.com/docs/grid">Grid
                                    component</a> and add the <code>.uk-grid</code> class to the slider. The elements will
                                then be spaced according to the grid gap. You can use the modifiers like
                                <code>.uk-grid-small</code> to change the gap.
                            </p>
                            </p>
                            ...
                            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
                                ...
                                <ul
                                    ...
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider1.jpg" alt="" class="rounded-md">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider2.jpg" alt="" class="rounded-md">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider3.jpg" alt="" class="rounded-md">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider4.jpg" alt="" class="rounded-md">
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/slider1.jpg" alt="" class="rounded-md">
                                    </li>
                            ...
                            <p class="text-base mb-10">By default, items of the slider always are aligned to the left. To
                                center the list items, just add <code>uk-slider="center: true"</code> to the attribute. </p>
                            ...
                            <p class="text-base mb-10"> To navigate through your slides, just use the
                                <code>uk-slider-item</code> attribute. To target the slides, set the attribute of every nav
                                item to the index number of the respective slider item. The elements with the
                                <code>uk-slider-item</code> attribute need to be inside the <code>uk-slider</code>
                                container. Setting the attribute to <code>next</code> and <code>previous</code> will switch
                                to the adjacent slides.
                            </p>
                ...
                <div>
                    ...
                    <div class="md:flex md:space-x-14">
                        <div class="md:w-3/4">
                            ...
                            <hr class="my-3">
                            <p class="text-sm mb-10">The Slideshow component is fully responsive and supports touch and
                                swipe navigation as well as mouse drag for desktops. When swiping between slides, the
                                animation literally sticks at your fingertips or mouse cursor. It even accelerates to keep
                                up with your pace when you click through previous and next navigation. All animations are
                            ...
                            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow>
                                ...
                                <ul class="uk-slideshow-items">
                                    <li>
                                        <img src="assets/images/demos/docs-demo/photo.jpg" alt="" uk-cover>
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/light.jpg" alt="" uk-cover>
                                    </li>
                                    <li>
                                        <img src="assets/images/demos/docs-demo/dark.jpg" alt="" uk-cover>
                                    </li>
                                </ul>
                            ...
                            <hr> <br>
                            <h3 class="text-lg font-semibold mb-2" id="Animations"> Animations</h3>
                            <p class="text-base mb-10"> By default, the slideshow uses a <code>slide</code> animation. You
                                can set the <code>animation</code> option to use a different animation. </p>
                            ...
                            <p class="text-base mb-10">To add a simple Ken Burns effect, wrap the image with a
                                <code>div</code> and add the <code>.uk-position-cover</code> and
                                <code>.uk-animation-kenburns</code> classes. You can also apply the
                                <code>.uk-animation-reverse</code> or one of the <code>.uk-transform-origin-*</code> classes
                                from the <a href="#">Utility component</a> to modify the effect.
                            </p>
                            ...
                            <p class="text-base mb-10">Add content overlays using the Position component. It allows you to
                                place the content anywhere inside the slide. </p>
                                ...
                                <ul class="uk-slideshow-items">
                                    <li>
                                        ...
                                        <div class="text-center uk-position-bottom p-5 backdrop-filter backdrop-blur-md">
                                            ...
                                            <p class="text-lg text-white">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                elit.</p>
                                        </div>
                                    </li>
                                    <li>
