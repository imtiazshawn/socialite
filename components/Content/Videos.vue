    ...
    <div class="main_content">
        <div class="mcontainer">
            ...
            <div class="flex justify-between relative md:mb-4 mb-3">
                ...
                <a href="#create-post-modal" uk-toggle
            ...
            <div class="relative" uk-slider="finite: true">
                ...
                <div class="uk-slider-container px-1 py-3">
                    <ul
                        ...
                        <!-- VIDEOS -->
                        <li v-if="videos.videos && videos.videos.length > 0" v-for="(video, index) in videos.videos"
                            :key="index">
                            ...
                            <div class="pt-3">
                                <a href="video-watch.html" class="font-semibold line-clamp-2"> {{ video.videoTitle }} </a>
                                <div class="pt-2">
                                    <a href="#" class="text-sm"> {{ video.channel }} </a>
                                    <div class="flex space-x-2 items-center text-sm mt-1">
                                        <div> {{ video.uploadTime }} ago</div>
            ...
            <div class="divide-y">
                ...
                <div class="flex md:space-x-6 space-x-4 md:py-5 py-3 relative"
                    v-if="videos.videos && videos.videos.length > 0" v-for="(video, index) in videos.videos" :key="index">
                    <a href="video-watch.html"
                    ...
                    <div class="flex-1 space-y-2">
                        ...
                        <a href="video-watch.html" class="md:text-xl font-semibold line-clamp-2"> {{ video.videoTitle }}
                        </a>
                        <p class="leading-6 pr-4 line-clamp-2 md:block hidden"> {{ video.description }} </p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="md:flex items-center justify-center h-9 px-8 rounded-md border hidden"> Add
                                favorites </a>
                        </div>
...
<script>
    ...
    export default {
        setup() {
            const videos = useTimeline();

            const fetchApiData = async () => {
                try {
                    await videos.fetchVideosData()
