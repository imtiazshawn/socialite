                ...
                <div class="uk-switcher lg:mt-8 mt-4" id="timeline-tab">
                        ...
                        <div class="w-full space-y-6">
                            ...
                            <div class="widget card p-5 border-t">
                                ...
                                <div class="grid grid-cols-3 gap-3 text-gray-600 font-semibold">
                                    <a href="#" v-if="profile.friends && profile.friends.length > 0" v-for="(friend, index) in profile.friends.slice(0, 5)" :key="index">  
                            ...
                            <div class="widget card p-5 border-t">
                                ...
                                <div>
                                  ...
                                  <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50" v-if="profile.groups && profile.groups.length > 0" v-for="(group, index) in profile.groups.slice(0, 4)" :key="index">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 mt-5">
                            ...
                            <div class="card" v-if="profile.pages && profile.pages.length > 0" v-for="(page, index) in profile.pages" :key="index">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-2  grid-cols-2 gap-x-2 gap-y-4 mt-3"> 
                            ...
                            <div class="flex items-center flex-col md:flex-row justify-center p-4 rounded-md shadow hover:shadow-md md:space-x-4" v-if="profile.groups && profile.groups.length > 0" v-for="(group, index) in profile.groups" :key="index">
