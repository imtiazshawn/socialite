                  ...
                  <!-- search icon for mobile -->
                    ...
                    <div class="right_side">
                        ...
                        <div class="header_widgets">
                            <nuxt-link to="pages-upgrade.html" class="is_link">  Upgrade </nuxt-link>   
                            ...
                            <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                                ...
                                <div class="drop_headline">
                                    <h4>  My Cart </h4>
                                    <nuxt-link to="/" class="btn_action hover:bg-gray-100 mr-2 px-2 py-1 rounded-md underline"> Checkout </nuxt-link>
                                </div>
                            ...
                            <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                                ...
                                <nuxt-link to="timeline.html" class="user">
                                ...
                                <hr>
                                <nuxt-link to="pages-upgrade.html" class="is-link">
                                ...
                                <hr>
                                <nuxt-link to="page-setting.html">
                                ...
                                <nuxt-link to="groups.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z"  clip-rule="evenodd" />
                                    </svg>
                                    Manage Pages 
                                </nuxt-link>
                                <nuxt-link to="pages-setting.html">
