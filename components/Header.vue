            ...
            <div class="header_inner mcontainer">
                ...
                <div class="right_side">
                    ...
                    <div class="header_widgets">
                        <nuxt-link to="/pages/upgrade" class="is_link"> Upgrade </nuxt-link>
                        <nuxt-link to="/" class="is_icon" uk-tooltip="title: Cart">
                        ...
                        <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                            ...
                            <div class="drop_headline">
                                <h4> My Cart </h4>
                                <nuxt-link to="/" class="btn_action hover:bg-gray-100 mr-2 px-2 py-1 rounded-md underline">
                                    Checkout </nuxt-link>
                            </div>
                            ...
                            <ul class="dropdown_cart_scrollbar" data-simplebar>
                                ...
                                <li>
                                    ...
                                    <div class="cart_text">
                                        <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1"> Parfum Spray
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="cart_text">
                                        <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1"> Herbal Shampoo
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="cart_text">
                                        <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1"> Wood Chair
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="cart_text">
                                        <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1"> Strawberries
                                            FreshRipe </div>
                        ...
                        <nuxt-link to="/" class="is_icon" uk-tooltip="title: Notifications">
                            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div class="dropdown_scrollbar" data-simplebar>
                                <div class="drop_headline">
                                    ...
                                    <div class="btn_action">
                                        <nuxt-link to="/" data-tippy-placement="left" title="Notifications">
                                            <ion-icon name="settings-outline"></ion-icon>
                                        </nuxt-link>
                                        <nuxt-link to="/" data-tippy-placement="left" title="Mark as read all">
                        ...
                        <!-- Message -->
                        <nuxt-link to="/" class="is_icon" uk-tooltip="title: Message">
                            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div uk-drop="mode: click" class="header_dropdown is_message">
                            ...
                            <nuxt-link to="/" class="see-all"> See all in Messages</nuxt-link>
                        </div>
                        ...
                        <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                            ...
                            <nuxt-link to="/timeline" class="user">
                            ...
                            <hr>
                            <nuxt-link to="/pages/upgrade" class="is-link">
                                <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <nuxt-link to="/" id="night-mode" class="btn-night-mode">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
