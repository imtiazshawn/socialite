    ...
    <div class="sidebar">
        ...
        <div class="sidebar_inner" data-simplebar>
            ...
            <ul>
                ...
                <li id="more-veiw" hidden><nuxt-link to="birthdays.html"> 
