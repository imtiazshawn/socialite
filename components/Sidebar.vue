<template>
    <div class="sidebar">
        ...
        <div class="sidebar_inner" data-simplebar>
            ...
            <ul>
                <li :class="{ active: $route.path === '/feed' }">
                    <nuxt-link to="/feed">
                ...
                <li :class="{active: $route.path === '/groups'}">
                    <nuxt-link to="/groups">
                        ...
                        </svg><span> Groups </span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/jobs'}">
                    <nuxt-link to="/jobs">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-pink-500">
                            <path fill-rule="evenodd"
                ...
                <li :class="{active: $route.path === '/courses'}">
                    <nuxt-link to="/courses">
                        ...
                        <span> Course</span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/games'}">
                    <nuxt-link to="/games">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-green-500">
                            <path
                                d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
                        </svg> <span> Games </span></nuxt-link>
                </li>

                <li :class="{active: $route.path === '/events'}" id="more-veiw" hidden>
                    <nuxt-link to="/events">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-yellow-500">
                            <path fill-rule="evenodd"
                                ...
                                clip-rule="evenodd" />
                        </svg><span> Events </span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/products'}" id="more-veiw" hidden><nuxt-link to="/products">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-red-500">
                            <path fill-rule="evenodd"
                        ...
                        <span> Products</span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/albums'}" id="more-veiw" hidden><nuxt-link to="/albums">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-purple-500">
                            <path fill-rule="evenodd"
                                d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z"
                                clip-rule="evenodd" />
                        </svg> <span> Photos </span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/blogs'}" id="more-veiw" hidden><nuxt-link to="/blogs">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-pink-500">
                            <path fill-rule="evenodd"
                ...
                <li :class="{active: $route.path === '/forums'}" id="more-veiw" hidden><nuxt-link to="/forums">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="text-blue-500">
                        ...
                        <span> forum</span> </nuxt-link>
                </li>
                <li :class="{active: $route.path === '/birthdays'}" id="more-veiw" hidden><nuxt-link to="/birthdays">
                        ...
                        <span> Birthdays </span> <span class="new">N</span></nuxt-link>
                </li>
                <li :class="{active: $route.path === '/fundraiser'}" id="more-veiw" hidden><nuxt-link to="/fundraiser">
            ...
            <nuxt-link to="#" class="see-mover h-10 flex my-1 pl-2 rounded-xl text-gray-600"
