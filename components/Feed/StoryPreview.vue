        ...
        <div class="story-content">
            ...
            <ul class="uk-switcher uk-animation-scale-up" id="story_slider">
                <li class="relative">
                    ...
                    <span uk-switcher-item="previous">
                        <ion-icon name="chevron-back-outline" class="slider-icon is-left" style="color: #8c8c8c;"></ion-icon>
                    </span>
                    <span uk-switcher-item="next">
                        <ion-icon name="chevron-forward-outline" class="slider-icon is-right"
                            style="color: #8c8c8c;"></ion-icon>
                    </span>
                ...
                <li class="relative">
                    ...
                    <span uk-switcher-item="previous">
                        <ion-icon name="chevron-back-outline" class="slider-icon is-left" style="color: #8c8c8c; font-size: 16px;"></ion-icon>
                    </span>
                    <span uk-switcher-item="next">
                        <ion-icon name="chevron-forward-outline" class="slider-icon is-right"
                            style="color: #8c8c8c;"></ion-icon>
                    ...
                    <div uk-lightbox>
                        <a href="../../assets/images/avatars/avatar-lg-1.jpg" data-alt="Image">
                            <img src="../../assets/images/avatars/avatar-lg-1.jpg" class="story-slider-image"
                                data-alt="Image">
                        </a>
                    </div>
                ...
                <li class="relative">
                    ...
                    <div uk-lightbox>
                        <a href="../../assets/images/avatars/avatar-lg-4.jpg" data-alt="Image">
                            <img src="../../assets/images/avatars/avatar-lg-4.jpg" class="story-slider-image"
                                data-alt="Image">
                        </a>
                    </div>
