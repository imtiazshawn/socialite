...
import BirthdaysContent from '../components/Content/BirthdaysContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, BirthdaysContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>