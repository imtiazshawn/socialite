<template>
  ...
  <script>
    ...
    import GamesContent from '../components/Content/GamesContent.vue';
    ...
    export default {
        name: "IndexPage",
        components: { Header, Sidebar, GamesContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
    }
  </script>