...
import FundraiserContent from '../components/Content/FundraiserContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, FundraiserContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>