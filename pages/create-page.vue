...
import CreatePage from '../components/Content/CreatePage.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, CreatePage, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>