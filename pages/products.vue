...
import ProductsContent from '../components/Content/ProductsContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, ProductsContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>