<template>
  ...
  <script>
    ...
    import CoursesContent from '../components/Content/CoursesContent.vue';
    ...
    export default {
        name: "IndexPage",
        components: { Header, Sidebar, CoursesContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
    }
  </script>