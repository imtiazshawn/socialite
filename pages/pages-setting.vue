...
import PagesSetting from '../components/Content/pagesSetting.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, PagesSetting, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>