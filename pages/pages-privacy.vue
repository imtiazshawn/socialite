...
import PagesPrivacy from '../components/Content/PagesPrivacy.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, PagesPrivacy, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>