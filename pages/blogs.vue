...
import BlogsContent from '../components/Content/BlogsContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, BlogsContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>