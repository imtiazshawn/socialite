...
import ForumsContent from '../components/Content/ForumsContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, ForumsContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>