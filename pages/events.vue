...
import EventsContent from '../components/Content/EventsContent.vue';
...
export default {
    name: "IndexPage",
    components: { Header, Sidebar, EventsContent, FeedBirthdayModel, OpenChatBox, FeedStoryPreview, CreatePost }
}
</script>